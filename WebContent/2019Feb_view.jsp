<!DOCTYPE html>
<html>
<title>2020 February Catalog - Sarasavi Publications</title>
														...
														<form action="AnnualView2019_Servlet" method="post">
															...
															<div class="col-md-6 ">
																<img class="" src="img-t/2019 fe.jpg"
																	style="height: 400px; width: 300px" alt="">
															</div>
															<div class="col-md-6 ">
																<div class="product__info">
																	<div class="product__wishlist-compare topic">2020
																		February Catalogue</div>
																	...
																	<div class="product__description">
																		...
																		<p class="subdata">Author&nbsp;: Sarasavi Group</p>
																			...
																			<p class="subdata">Isbn No&nbsp;: Spcbk2020Feb</p>
																	...
																	<div class="form-group product__option">
																		...
																		<div class="product__actions">
																			...
																			<br> <input type="hidden" id="bookname"
																				name="bookname"
																				value="2020 February Catalogue Catalogue">
																			<input type="hidden" id="author" name="author"
																				value="Sarasavi Group"> <input type="hidden"
																				id="publisher" name="publisher"
																				value="Sarasavi Publishers"> <input
																				type="hidden" id="isbnno" name="isbnno"
																				value="Spcbk2020Feb"> <input type="hidden"
