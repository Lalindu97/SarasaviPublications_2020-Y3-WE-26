<!DOCTYPE html>
<html>
<title>2020 January Catalog- Sarasavi Publications</title>
...
<link rel="stylesheet" type="text/css" href="Content/singlebook.css">
		...
		<div class="w3-white">
			...
			<div class="w3-container">
				...
				<div class="main">
					...
					<!-- /# Paste our code here -->
					<section>
						<div class="site__body mt-5 mb-5">
							...
							<div class="block">
								<div class="container">
									<product-view> <input type="hidden"
										name="_token" value="MpPI4aOpDpzPaWhdNWLmZVIOBH6yFTzwtgQDh25w">
									<input type="hidden" name="product" value="304995">


									<div class="product product--layout--columnar"
...
<br><br><br>
											<div class="product__gallery" style="position: relative">
														...
														<form action="AnnualView2019_Servlet" method="post">
															...
															<div class="col-md-6 ">
																<div class="product__info">
																	<div class="product__wishlist-compare topic">2020
																		January Catalogue</div>
																	...
																	<div class="product__description">
																		...
																		<p class="subdata">Author&nbsp;: Sarasavi Group</p>
																		<p class="subdata">Publisher&nbsp;: Sarasavi Publishers</p>
																		<p class="subdata">Isbn No&nbsp;: Spcbk2020Jan</p>
																		
																		<p class="subdata">Availability:&nbsp;: In Stock</p>
																	...
																	<div class="product__prices">
																		<div class="product-price">
																			...
																			<span class="money">LKR 1,500.00</span>
																		</div>
																		...
																		<div class="form-group product__option">
																			<div class="row">
																				<div class="col-md-2 ">
																					<label class="product__option-label"
																						for="product-quantity"><h4>Quantity</h4></label>
																				</div>
																				<div class="col-md-2 ">
																					<input
																						class="input-number__input form-control form-control-lg"
																						type="number" min="1" name="quantity"
																						id="quantity" class="control quantity-change"
																						value="1"
																			...
																			<div class="product__actions">
																				...
																				<br> <input type="hidden" id="bookname"
																					name="bookname"
																					value="2020 January Catalogue Catalogue">
																				<input type="hidden" id="author" name="author"
																					value="Sarasavi Group"> <input
																					type="hidden" id="publisher" name="publisher"
																					value="Sarasavi Publishers"> <input
																					type="hidden" id="isbnno" name="isbnno"
																					value="Spcbk2020Jan"> <input type="hidden"
																					id="price" name="price" value="1500.00">
																					<div
																				class="product__actions-item product__actions-item--addtocart">
																				<div class="row">
																					<div class="col-md-6 ">
																						<button type="submit"
																							class="btn btn-lg btn-primary addtocart">Add
																							To Cart</button>
																					...
																					<input type="hidden" id="WishList" name="WishList"
																						value="WishList">
...
</div></div></div></form></div></div></div></div></div></product-view></div></div></div></section></div>
								<hr>
