<!DOCTYPE html>
<html>
<title>Sarasavi Publications - Sarasavi Publications</title>
						...
						<div id="myCarousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<img src="img-t/sarsavibanner1.jpg" alt="Los Angeles"
										style="width: 100%; height: 10%">
								</div>

								<div class="item">
									<img src="img-t/sarasavibanner2.jpg" alt="Los Angeles"
										style="width: 100%; height: 10%">
								</div>

								<div class="item">
									<img src="img-t/sarsavibanner3.jpg" alt="Los Angeles"
										style="width: 100%; height: 10%">
								</div>
							</div>
...
href="http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp"><b>Sarasavi
							...
							<div class="card-body">
								...
								<br>	<div class="row ml-3 mr-3 mb-3 mt-3">
									<div class="col-md-4">
										<h4 class="card-subtitle mb-2 text-muted">
											<a class="d-flex justify-content-center"
												href="http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
					...
					<div class="col-lg-6 mb-4">
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								...
								</div><br>						<div class="row ml-3 mr-3 ">
									<div class="col-md-6">
										<h4 class="card-subtitle mb-2 text-muted">
											<a class="d-flex justify-content-center"
												href="http://localhost:8081/Sarasavi_Publications/Sarasavi_Best_Selling_Books.jsp">
								...
								</div><br>	<br>			<div class="row ml-3 mr-3 mb-3 mt-3">
									<div class="col-md-6">
										<h4 class="card-subtitle mb-2 text-muted">
											<a class="d-flex justify-content-center"
												href="http://localhost:8081/Sarasavi_Publications/Sarasavi_Best_Selling_Books.jsp">
								...
								</div><br>				<div class="row ml-3 mr-3 mb-3 mt-3">
									<div class="col-md-6">
										<h4 class="card-subtitle mb-2 text-muted">
											<a class="d-flex justify-content-center"
												href="http://localhost:8081/Sarasavi_Publications/Sarasavi_Best_Selling_Books.jsp">
