<!DOCTYPE html>
<html>
<title>New Arrivals - Sarasavi Publications</title>
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						...
						<div class="col-md-3 ">
							<div class="product__info">
								<div class="product__wishlist-compare">
									<h4><b>The Law Relating To Literary And Artise And Creation In Sri Lanka</b></h4>
								</div>
								<br>
								<div class="product__description">
									<p>Author&nbsp;  : L Alwis</p>
								...
								<div class="product__options">
									<div class="form-group product__option">
										...
										<div class="product__actions">
											...
											<br> 
											<input type="hidden" id="bookname" name="bookname" value="The Law Relating To........."> 
